...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::create(['name' => 'Sami', 'email' => 'sami@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('123456'), 'remember_token' => Str::random(10),]);

        User::create(['name' => 'Mansour', 'email' => 'mansour@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('123456'), 'remember_token' => Str::random(10),]);

        User::create(['name' => 'Zain', 'email' => 'zain@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('123456'), 'remember_token' => Str::random(10),]);

        User::create(['name' => 'Ali', 'email' => 'ali@gmail.com', 'email_verified_at' => now(), 'password' => bcrypt('123456'), 'remember_token' => Str::random(10),]);
